        ...
        <div className="row">
          <div className="col">
            <div className="form-group">
              ...
              <textarea type="text" className="form-control" id="InputStepInstruciton" placeholder="Step Instructions" value={this.props.step.instructions} onInput={(event) => { this.props.changeInstructions(this.props.stepIndex, event.target.value); }} />
            </div>
          </div>
        </div>
        {ingredients}
