    ...
    return (
      <div>
        ...
        <Modal open={open} onClose={this.onCloseModal} center>
          ...
          <div><DetailedPopup getRecipeById={this.props.getRecipeById} recipe={this.props.recipe} toggleViews={this.props.toggleViews} sporkRecipe={this.props.sporkRecipe} onClose={this.onCloseModal} current_user_id={this.props.current_user_id}/></div>
        </Modal>
      </div>
    );
  }
